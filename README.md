...
Главната функција која овозможува движење на фигурите е функцијата moveFigure(int kocka, int figureNum). Враќа bool со цел да се одреди дали поместувањето било успешно. Како аргументи прима int kocka кој преставува бројот на коцката по добиеното вртене и int figureNum преку кое е се пренесува бројот на фигурата која сакаме да ја поместиме. Функцијата корисити неколку помошни функции за проверка дали на стартаната позиција има веќе фигура со иста боја и функција за проверка на преклопување на фигурите доколку се направи поместување.
```
...
Втората форма или формата Game е главното платно каде што се игра играта. Во оваа форма најпрво се исцртува целата мапа и се поставува локацијата за секоја од позиција. Во зависност од подесувањата на корисникот се поставуваат активните играчи на таблата. Играњето на играта во најголем дел се контролира со две копчиња како и фигурите кои се преставени со копчиња. Кога еден играч ќе дојде на ред тој прво мора да ја притисне со еден клик коцката со цел истата да се заврти а потоа со следниот клик ја стопира и добива резултат од вртењете. По завршувањето на вртењето на коцката фигурите на играчот се овозможуваат со што тој може да ги придвижи. Тука се прави и проверка доколку нема валидни потези се овозможува копчето за следен потег а доколку има валидни потези тој мора да го направи пред да продолжи со следниот потег.
```
...
```
Повикот за функцијата придвижување на фигурите се прави во функција за клик на  фигура. Доколку се придвижи фигурата се повикува и функција за туркање на друга фигура доколку на таа позиција се наоѓа друга фигура. Исто така се овозможува и копчето за следен потег.
```
